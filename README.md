...
This project was developed by Raj Pasupathy using Anthropic and ChatGPT as development assistants. Additionally, the application itself integrates **Anthropic's Claude API** to provide AI-powered customer insights.
